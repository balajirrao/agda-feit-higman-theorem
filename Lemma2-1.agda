...
module Lemma2-1 where
  ...
  module Lemma2-1-pt where
    lem₀ : {e : P} {e₁ : L# e} {f : X}  → Even (lambda (pt e) f) → Odd (lambda (ln (L#.l e₁)) f)
    lem₀ {e₁ = l , #} {pt x} x₁ = lem-lp
    lem₀ {e} {e₁ = l , #} {ln x} x₁ = ⊥-elim (oddEvenEither x₁ lem-pl)

    lem₁ : {e : P} {e₁ : L# e} {f : X}  → Odd (lambda (pt e) f) → Even (lambda (ln (L#.l e₁)) f)
    lem₁ {e₁ = l , #} {pt x} x₁ = ⊥-elim (oddEvenEither lem-pp x₁)
    lem₁ {e₁ = l , #} {ln x} x₁ = lem-ll

    lem₂ : {e : P} {e₁ : L# e} {f : X} → lambda (pt e) f ≡ n → lambda (ln (L#.l e₁)) f ≡ n → ⊥
    ...
    lem₃ : {e : P} {e₁ : L# e} {f : X} → lambda (pt e) f ≡ n → lambda (ln (L#.l e₁)) f < n
    lem₃ {e} {e₁} {f} λ≡n = ≤-≢⇒< (A₁' {ln (L#.l e₁)} {f}) (lem₂ {e} {e₁} λ≡n)

    lem₄ : {e : P} {e₁ : L# e} {f : X} → lambda (pt e) f ≡ n → lambda (ln (L#.l e₁)) f < (pred (n)) → ⊥
    lem₄ {e} {e₁} {f} λ≡n p with sc-is-shorter-than (_∷_ (pt e) {{fromWitnessFalse (λ ())}} {{T#sym (L#.# e₁)}} (sc (ln (L#.l e₁)) f))
    ...
    F e f₁ (_∷_ .(pt e) {{e<>f}} {{e#f}} c , len≡n) | ln x = x , T#sym e#f

    F⁻¹ : (e : P) (f : X) → lambda (pt e) f ≡ n →  L# e → Subset (chain (pt e) f) (λ c → len c ≡ n) 
    F⁻¹ e f λ≡n (l , #)  = _∷_ (pt e) {{fromWitnessFalse (λ ())}} {{T#sym #}} (sc (ln l) f) , PropEq.cong suc (lem₅ λ≡n)
    ...
    lem-id e f₁ λ≡n (_∷_ .(pt e) {{e<>f}} {{e#f}} c , proof) | ln x with PropEq.cong (Subset.elem) (A₂ ((sc (ln x) f₁) , ≡⇒≤ (PropEq.cong suc (lem₅ {e} {x , (T#sym e#f)} λ≡n))) (c , (≡⇒≤ proof)))
  ...
  module Lemma2-1-ln where
    lem₀ : {e : L} {e₁ : P# e} {f : X}  → Even (lambda (ln e) f) → Odd (lambda (pt (P#.p e₁)) f)
    lem₀ {e₁ = l , #} {ln x} x₁ = lem-pl
    lem₀ {e} {e₁ = l , #} {pt x} x₁ = ⊥-elim (oddEvenEither x₁ lem-lp)

    lem₁ : {e : L} {e₁ : P# e} {f : X}  → Odd (lambda (ln e) f) → Even (lambda (pt (P#.p e₁)) f)
    lem₁ {e₁ = l , #} {ln x} x₁ = ⊥-elim (oddEvenEither lem-ll x₁)
    lem₁ {e₁ = l , #} {pt x} x₁ = lem-pp

    lem₂ : {e : L} {e₁ : P# e} {f : X} → lambda (ln e) f ≡ n → lambda (pt (P#.p e₁)) f ≡ n → ⊥
    lem₂ {e} {e₁} {f} λ≡n eq with parity (lambda (ln e) f)
    ... | isEven p = oddEvenEither (subst Even (trans λ≡n (sym eq)) p) (lem₀ {e} {e₁} p)
    ... | isOdd p = oddEvenEither (lem₁ {e} {e₁} p)  (subst Odd (trans λ≡n (sym eq)) p)

    lem₃ : {e : L} {e₁ : P# e} {f : X} → lambda (ln e) f ≡ n → lambda (pt (P#.p e₁)) f < n
    lem₃ {e} {e₁} {f} λ≡n = ≤-≢⇒< (A₁' {pt (P#.p e₁)} {f}) (lem₂ {e} {e₁} λ≡n)

    lem₄ : {e : L} {e₁ : P# e} {f : X} → lambda (ln e) f ≡ n → lambda (pt (P#.p e₁)) f < (pred (n)) → ⊥
    lem₄ {e} {e₁} {f} λ≡n p with sc-is-shorter-than (_∷_ (ln e) {{fromWitnessFalse (λ ())}} {{T#sym (P#.# e₁)}} (sc (pt (P#.p e₁)) f))
    ...
    F e f₁ (_∷_ .(pt e) {{e<>f}} {{e#f}} c , len≡n) | pt x = x , T#sym e#f

    F⁻¹ : (e : L) (f : X) → lambda (ln e) f ≡ n →  P# e → Subset (chain (ln e) f) (λ c → len c ≡ n) 
    F⁻¹ e f λ≡n (l , #)  = _∷_ (ln e) {{fromWitnessFalse (λ ())}} {{T#sym #}} (sc (pt l) f) , PropEq.cong suc (lem₅ λ≡n)
    ...
    lem-id e f₁ λ≡n (_∷_ .(ln e) {{e<>f}} {{e#f}} c , proof) | pt x with PropEq.cong (Subset.elem) (A₂ ((sc (pt x) f₁) , ≡⇒≤ (PropEq.cong suc (lem₅ {e} {x , (T#sym e#f)} λ≡n))) (c , (≡⇒≤ proof)))
